...
const DashboardIncorporacionCB = ({ children }) => {
  ...
  const contextValue = {
    datos, loading, error, filters, setFilters, filteredData, stats,
...
const COLORS_OBJETIVOS = ['#ef4444', '#f87171', '#fca5a5', '#fecaca', '#fee2e2', '#fef2f2'];  // Rojo
const COLORS_PREMISAS = ['#14b8a6', '#2dd4bf', '#5eead4', '#99f6e4', '#ccfbf1', '#f0fdfa']; // Teal
const COLORS_ENFOQUES = ['#3b82f6', '#60a5fa', '#93c5fd', '#bfdbfe', '#dbeafe', '#eff6ff'];    // Azul
const COLORS_PERSPECTIVAS = ['#8b5cf6', '#a78bfa', '#c4b5fd', '#ddd6fe', '#ede9fe', '#f5f3ff']; // Violeta
